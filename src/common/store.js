...
const state = {
    ...
    FuncDialogStatus: FuncDialogStatus//功能的form的状态
}
...
const mutations = {
    ...
    //新建功能的form的对话框状态
    setFuncDialogStatus: function (state, status) {
        state.FuncDialogStatus = status;
    }
}
...
const getters = {
    ...
    getFuncDialogStatus: state => { return state.FuncDialogStatus }
